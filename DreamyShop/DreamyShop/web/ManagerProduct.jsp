                ...
                <div class="modal-content">
                    <form action="add" method="post">
                        ...
                        <div class="modal-body">					
                            ...
                            <div class="form-group">
                                <label>OS</label>
                                <textarea name="OS" class="form-control" required></textarea>
                            </div>
                            <div class="form-group">
                                <label>processor</label>
                                <textarea name="processor" class="form-control" required></textarea>
                            </div>
                            <div class="form-group">
                                <label>memory</label>
                                <textarea name="memory" class="form-control" required></textarea>
                            </div>
                            <div class="form-group">
                                <label>graphics</label>
                                <textarea name="graphics" class="form-control" required></textarea>
                            </div>
                            <div class="form-group">
                                <label>storage</label>
                                <textarea name="storage" class="form-control" required></textarea>
                            </div>
                            <div class="form-group">
