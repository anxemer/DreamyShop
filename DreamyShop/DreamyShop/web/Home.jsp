                        ...
                        <div class="col-lg-12 col-md-6 col-12">
                            ...
                            <div class="hero-small-banner style2">
                                <div class="content">
                                    ...
                                    <div class="button">
                                        <a class="btn" href="free">Shop Now</a>
                                    </div>
                                </div>
                            </div>
                            <!-- Start Small Banner -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="single-banner" style="background-image:url('https://upload.wikimedia.org/wikipedia/commons/a/a0/Nintendo_Switch_logo%2C_horizontal.png')">
                        <div class="content">
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="single-banner custom-responsive-margin"
                        style="background-image:url('https://d9n64ieh9hz8y.cloudfront.net/wp-content/uploads/20190412094157/10-game-do-hoa-nintendo-switch.jpg')">
                        <div class="content">
