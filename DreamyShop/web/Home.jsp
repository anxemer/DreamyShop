...
<!--                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                    ...
                                    <div class="button">
                                        <a href="Detail.jsp" class="btn">BUY</a>
                                    </div>
                                </div>
                            </div>
                            <!-- End Single Slider -->
                        ...
                        <div class="col-lg-12 col-md-6 col-12">
                            ...
                            <div class="hero-small-banner style2">
                                <div class="content">
                                    ...
                                    <div class="button">
                                        <a class="btn" href="FreeGame.jsp">Shop Now</a>
                                    </div>
                                </div>
                            </div>
                            <!-- Start Small Banner -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="single-banner" style="background-image:url('https://upload.wikimedia.org/wikipedia/commons/thumb/0/04/Nintendo_Switch_logo%2C_square.png/480px-Nintendo_Switch_logo%2C_square.png')">
                        <div class="content">
